...
import net.mcreator.boudicasmod.particle.SurfureDustParticle;
...
public class SulfurOreBlock extends BoudicasModModElements.ModElement {
	@ObjectHolder("boudicas_mod:sulfur_ore")
	public static final Block block = null;
	public SulfurOreBlock(BoudicasModModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SulfurDustItem.block, (int) (2)));
		}
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			if (true)
				for (int l = 0; l < 4; ++l) {
					...
					world.addParticle(SurfureDustParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
	@Override
